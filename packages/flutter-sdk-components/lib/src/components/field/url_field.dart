...
/// URL component for URL field input
/// Similar to the React SDK's URL component
  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        hintText: props.placeholder ?? 'Enter URL',
...
/// Builder function for URL component
Widget buildUrl(Map<String, dynamic> props, List<Widget> children) {
  return UrlField(
