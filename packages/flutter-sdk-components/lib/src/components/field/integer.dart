...
/// Integer component for integer number field input
/// Similar to the React SDK's Integer component
...
class _IntegerFieldState extends State<IntegerField> {
  ...
  @override
  void didUpdateWidget(IntegerField oldWidget) {
...
/// Builder function for Integer component
Widget buildInteger(Map<String, dynamic> props, List<Widget> children) {
  return IntegerField(
