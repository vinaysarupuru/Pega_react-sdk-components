...
/// Decimal component for decimal number field input
/// Similar to the React SDK's Decimal component
...
/// Builder function for Decimal component
Widget buildDecimal(Map<String, dynamic> props, List<Widget> children) {
  return DecimalField(
